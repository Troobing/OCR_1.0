...
cd backend
venv\Scripts\python.exe -m PyInstaller --onefile --noconsole --icon app.ico --add-data "../frontend/dist;frontend/dist" --add-data ".env;." --collect-all latex2mathml --name "OCR-Agent" --distpath ".." desktop.py
cd ..
